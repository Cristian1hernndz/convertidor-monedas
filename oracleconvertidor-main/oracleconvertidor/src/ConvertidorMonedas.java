...
public class ConvertidorMonedas {
    ...
    private static <JSONException> void sendHttpGETRequest(String fromCode, String toCode, double amount) {
    ...
    private static <JSONObject> double getExchangeRate(String toCode, HttpURLConnection httpURLConnection) throws IOException {
